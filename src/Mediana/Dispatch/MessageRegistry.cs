...
/// <summary>
/// Immutable message registry: RuntimeTypeHandle → <see cref="MessageEntry"/>.
/// Purely functional copy-on-write: <see cref="Add"/> and this —
/// inin butin inand on butin and (bytoinbut Adds onandin and)
/// toinand from but inandand — by innotnot andfromand inin (toandinbut)
/// and all without in and and
/// net10.0 — FrozenDictionary; netstandard2.1 — in immutable bucket-andin (D2)
/// </summary>
public sealed class MessageRegistry
{
    ...
    /// <summary>Read without allocations or locks. null means the type is not registered.</summary>
    ...
    /// <summary>
    /// Copy-on-write toinand: and and — this notfromnot, inin butin inand
    /// alland andand butin. and — and andandand
    /// </summary>
