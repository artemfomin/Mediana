...
/// <summary>andand and inthen QueryCallSite: ref-, typed-ref, async-cast, InvokeAny /.</summary>
public class QueryFinalBranchTests
{
    ...
    public async Task Value_query_invoke_any_and_async_typed()
    {
        ...
        // value: no bridge → generic slow- and (async)
