...
/// <summary>: query-and all andin, parallel-async andand, async-cast, scoped query.</summary>
public class QueryPathCoverageTests
{
    ...
    {
        // in inin Slow: andin bybutin + (ref-fromin)
    ...
    public void Registry_build_empty_and_single_bucket_paths()
    {
        ...
        // butin toinand — and (ns2.1) / rebuild (net10)
        // 40 andbyin — and (ns2.1) / rebuild (net10)
